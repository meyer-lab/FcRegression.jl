...
[**Predicted synergistic/antagonistic immunothrombocytopenia (ITP) and melanoma IgG subclass pairs.** a,b) Predicted depletion caused by combinations of IgG1 and IgG2a across all cell types for two regression models: a) melanoma, c) ITP; b,d) Predicted depletion synergy caused by various IgG combinations across cell types for two regression models: b) melanoma, d) ITP; e) Predicted total ligand bound with a combination of IgG1 and IgG2a across cMO cells; f) Predicted ](figure4.svg "Figure 2"](figure4.svg "Figure 4"){#fig:prediction width="100%"}
