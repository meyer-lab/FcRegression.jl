...
function plotActualvPredict()
    ...
    title!(pl, "Actual effect vs LOO predicted for Bone CD20")
    return pl
end
...
function plotCellTypeEffects()
    ...
    title!(pl, "Weights of IgGx + celltype in wt for Bone CD20")
    return pl
end
