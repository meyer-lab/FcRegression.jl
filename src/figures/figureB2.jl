...
function figureB2()
    p1, p2, p3, p4 = figureW("melanoma"; L0 = 1e-9, f = 4, murine = true)
...
function figureB3()
    p1, p2, p3, p4 = figureW("ITP"; L0 = 1e-9, f = 4, murine = true)
...
function figureB4()
    p1, p2, p3, p4 = figureW("blood"; IgGX = 1, IgGY = 3, L0 = 1e-9, f = 4, murine = true)
...
function figureB5()
    p1, p2, p3, p4 = figureW("bone"; IgGX = 1, IgGY = 3, L0 = 1e-9, f = 4, murine = true)
...
function figureB6()
    p1, p2, p3, p4 = figureW("HIV"; IgGX = 1, IgGY = 3, L0 = 1e-9, f = 4, murine = true)
