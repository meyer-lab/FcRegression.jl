...
function plot_mix_ITP_depletion()
    ...
    setGadflyTheme()
    return plot(df, x="depletion", y="Predicted", color="Dose", Geom.point, Geom.abline(color = "green"), 
        Guide.title("Mice <i>in vivo</i> platelet depletion"), Guide.xlabel("Measured"),
...
function figure5()
    ...
    draw(SVG("figure5.svg", 4inch, 3inch), pl)
end
