...
function figure5(ssize = (9inch, 9inch); cellTypes = nothing, mcmc_iter = 500, suffix = "1011_N", kwargs...)
    ...
    pl = FcRegression.plotGrid(
        (3, 3),
        [nothing, pl_map0, pl_map1, nothing, cell_map0, cell_map1, nothing, act_map0, act_map1];
        sublabels = "abc de fg",
        kwargs...,
    )
