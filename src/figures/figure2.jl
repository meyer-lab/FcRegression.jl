...
function figure2()
    ...
    pure_fit = plotPredvsMeasured(df[(df."%_1" .== 1) .| (df."%_2" .== 1), :]; xx = "Value")

    draw(SVG("figure2.svg", 18inch, 11inch), plotGrid((2, 3), [nothing, all_fit, pure_fit, nothing, nothing, nothing]; sublabels = [1 1 1 0 1 1]))
end
