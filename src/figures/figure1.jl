...
function figure1()
    ...
    LP = plot(loading, x = "PC 1", y = "PC 2", color = "Cell", label = "Cell", Geom.point, Geom.label, Guide.title("PCA Loadings"),
        Scale.x_continuous(minvalue=-1.0, maxvalue=1.0), Scale.y_continuous(minvalue=-1.0, maxvalue=1.0))
    LP_13 = plot(loading, x = "PC 1", y = "PC 3", color = "Cell", label = "Cell", Geom.point, Geom.label, Guide.title("PCA Loadings"),
        Scale.x_continuous(minvalue=-1.0, maxvalue=1.0), Scale.y_continuous(minvalue=-1.0, maxvalue=1.0))
