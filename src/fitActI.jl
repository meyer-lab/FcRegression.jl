...
function figure_fitActI()
    ...
    for i = 1:6
        ...
        draw(
            SVG("figure_fitActI1_M" * dataType * ".svg", 1200px, 800px),
            plotGrid((2, 3), [p1, p2, p3, p4, p5, p6], join(string.(w), " "); widths = [5 5 4; 4 6 4]),
        )
        pls, w = fitActI(dataType; L0 = L0s[i], f = fs[i], murine = true, lower = [0.0, -5, 0, 0], upper = [5.0, 5, 5, 5])
        p1, p2, p3, p4, p5, p6 = pls
        draw(
            SVG("figure_fitActI2_M" * dataType * ".svg", 1200px, 800px),
            plotGrid((2, 3), [p1, p2, p3, p4, p5, p6], join(string.(w), " "); widths = [5 5 4; 4 6 4]),
        )
        pls, w = fitActI(dataType; L0 = L0s[i], f = fs[i], murine = true, lower = [-5.0, -5, -5, -5], upper = [5.0, 5, 5, 5])
        p1, p2, p3, p4, p5, p6 = pls
        draw(
            SVG("figure_fitActI3_M" * dataType * ".svg", 1200px, 800px),
            plotGrid((2, 3), [p1, p2, p3, p4, p5, p6], join(string.(w), " "); widths = [5 5 4; 4 6 4]),
        )
        pls, w = fitActI(dataType; L0 = L0s[i], f = fs[i], murine = true, lower = [0.0, 0, 0, 0], upper = [5.0, 5, 5, 5], init = [1.0, 1, 1, 1])
        p1, p2, p3, p4, p5, p6 = pls
        draw(
            SVG("figure_fitActI4_M" * dataType * ".svg", 1200px, 800px),
            plotGrid((2, 3), [p1, p2, p3, p4, p5, p6], join(string.(w), " "); widths = [5 5 4; 4 6 4]),
        )
    end
end
